...
namespace JrTunes
{
    public static class curso_parte_1
    {
        public static void SelectToEntitiesMain()
        {
        ...
        public static void Linq_Max_Min_Avg(JrTunesEntities contexto)
        {
            //MAX
            //MIN
            //AVG
        ...
        public static void LinqGoupBy(JrTunesEntities contexto)
        {
        ...
        public static void LinqSumarizando(JrTunesEntities contexto)
        {
            var query = from inf in contexto.ItemNotaFiscal
                        where inf.Faixa.Album.Artista.Nome == "Led Zeppelin"
        ...
        public static void SelectCountLinq(JrTunesEntities contexto)
        {
        ...
        public static void Select_NomeArista_E_NomeAlbum(JrTunesEntities contexto, string nomeArtista, string nomeAlbum)
        {
        ...
        public static void SelectToEntitiesConsultaComJoin_E_DepoisMesmaConsultaSemJoin(JrTunesEntities contexto)
        {
        ...
        public static void SelectToEntitiesContains(JrTunesEntities contexto)
        {
        ...
        public static void SelectToEntitiesConsultaTop10(JrTunesEntities contexto)
        {
        ...
        public static void SelectToEntitiesConsultaSimples(JrTunesEntities contexto)
        {
            /*
             * Consulta simples
             */
        ...
        public static void SelectNoXMLLinq()
        {
        ...
        public static void SelectComJoinLinq()
        {
            ...
            var generos = new List<Genero>
            {
                ...
                new Genero{GeneroId=2, Nome="Reggae"},
                new Genero{GeneroId=3, Nome="Rock Progressivo"},
                new Genero{GeneroId=4, Nome="Punk Rock"},
                new Genero{GeneroId=5, Nome="Clássica"}
            };

            var query = from m in musicas
                        join g in generos
                        on m.GeneroId equals g.GeneroId
        ...
        public static void SelectSimplesLinq()
        {
            var generos = new List<Genero>
            {
                new Genero{GeneroId=1, Nome="Rock"},
